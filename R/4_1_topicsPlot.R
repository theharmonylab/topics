...
#' @param scatter_legend_circles Concentric circles
#' @param scatter_legend_circles_radius Radius of first circle
...
generate_scatter_plot <- function(
  ...
  if (is.null(y_col)){
    ...
    #Add concentric circles for 2d plots
  if(!is.null(y_col) && scatter_legend_circles){

    if(scatter_legend_circles_radius == 0) 
    { radius <- interval/2 } else {radius <- scatter_legend_circles_radius}
