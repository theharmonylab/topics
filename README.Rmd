...
## text and topics
The topics-package supports the [www.r-text.org](https://r-text.org/) in analysing and visualizing topics. In the text-package you can visualise BERTtopics based on techniques from the topics package. 


![](man/figures/text_topics.svg){width=25%}
