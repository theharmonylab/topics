...
## Installation
The topics package uses <b>JAVA</b>, which is another programming language. Please start by downloading and installing it from https://www.java.com/en/download/manual.jsp. Then open R and run:
